...
//CSS:
import "@/assets/styles/css/utils/components/navbar/navbar.css";
...
import imgIconSocialMediaSuperior from "@/assets/images/utils/components/navbar/icon-social-media-superior.png";
...
function Navbar(props) {
    ...
    const pagesServices = [
        ...
        },
        {
            ...
            icon: null,
            img: imgIconSocialMediaSuperior,
            alt: "Icono de Social Media Superior",
    ...
    const ItemSubMenu = ({ styleName, iconId, label, img, alt }) => {
        return (
            <Box
                className="container-item-submenu"
                onClick={handleCloseSubMenu}
            >
                <Button
                    className={`icon-btn icon-btn--${styleName}`}
                    type="button"
                >
